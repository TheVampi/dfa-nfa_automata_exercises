...
This shows how the grammar generates the accepted string "**11101**". This path is non-deterministic, as the grammar "guesses" the correct rule (`S → 0 Q1`) at the right moment.
